...
export default function EducationCerts() {
  ...
  return (
    <section id="education" className="py-20 max-w-6xl mx-auto px-6 text-current scroll-mt-20">
              ...
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="font-mono text-sm sm:text-base font-bold text-current group-hover:text-orange-400 transition-colors uppercase tracking-wide">
                      {edu.degree}
                    </h3>
