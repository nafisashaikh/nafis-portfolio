...
export default function Hero({ onOpenPDF }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-theme-500/5 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <div className="h-10 mt-3 flex items-center">
              <div className="font-mono text-xs sm:text-sm tracking-[0.3em] text-slate-400 flex items-center gap-2 uppercase">
                ...
                <span className="relative">
                  {displayText}
                  <span className="absolute -right-2 top-0 bottom-0 w-[2px] bg-theme-500 animate-pulse" />
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-4">
            <button
              ...
              className="flex items-center justify-center gap-2 px-6 py-3.5 bg-theme-500 text-black hover:bg-theme-600 font-mono text-xs font-bold uppercase tracking-widest transition-all duration-300 active:scale-95 cursor-pointer"
            >
        ...
        >
          ...
          <div className="w-full max-w-[360px] bg-white/[0.02] backdrop-blur-md border border-white/10 p-6 relative overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.7)] group hover:border-theme-500/20 transition-all duration-500">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 border border-theme-500 flex items-center justify-center relative overflow-hidden transition-all duration-300 group-hover:bg-theme-500/10 shrink-0">
            ...
            {/* Glowing bottom line */}
            <div className="h-[1px] bg-gradient-to-r from-transparent via-theme-500/20 to-transparent mt-6" />
          </div>
        </motion.div>
      </motion.div>
    </section>
