...
export default function Hero({ onOpenPDF }: HeroProps) {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col justify-center relative pt-40 pb-20 px-6 max-w-6xl mx-auto overflow-hidden text-current"
    >
      ...
      <div className="grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-sans font-light tracking-tighter text-current leading-none">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-4">
            ...
            <button
              onClick={onOpenPDF}
              className="flex items-center justify-center gap-2 px-6 py-3.5 bg-transparent text-current hover:text-black hover:bg-white font-mono text-xs font-bold uppercase tracking-widest border border-white/20 hover:border-white transition-all duration-300 active:scale-95 cursor-pointer"
            >
        ...
        <div className="lg:col-span-5 relative flex justify-center">
          ...
          <div className="w-full max-w-[360px] bg-white/[0.02] backdrop-blur-md border border-white/10 p-6 relative overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.7)] group hover:border-orange-500/20 transition-all duration-500">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="font-mono text-xs font-semibold tracking-wider text-current uppercase">Nafit Abid Shaikh</h3>
            ...
            <div className="space-y-4">
              <div className="bg-white/[0.02] border border-white/5 p-3 flex items-start gap-2.5">
                ...
                <div>
                  <h4 className="font-mono text-[10px] uppercase font-bold tracking-wider text-current">Structured Analytics</h4>
              ...
              <div className="bg-white/[0.02] border border-white/5 p-3 flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-orange-500 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-mono text-[10px] uppercase font-bold tracking-wider text-current">SIH Hackathon Winner</h4>
                  <p className="text-[10px] font-sans text-slate-400 mt-1 leading-relaxed">
              ...
              <div className="bg-white/[0.02] border border-white/5 p-3 flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-orange-500 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-mono text-[10px] uppercase font-bold tracking-wider text-current">Forensic Simulation</h4>
                  <p className="text-[10px] font-sans text-slate-400 mt-1 leading-relaxed">
