...
export default function SkillsGrid() {
  ...
  return (
    <section id="skills" className="py-20 max-w-6xl mx-auto px-6 dark:text-white text-slate-900 scroll-mt-20">
              ...
              <div className="flex flex-wrap gap-1.5">
                {cat.items.map((skill, sIdx) => {
                  return (
                    <span
                      key={sIdx}
                      className="px-2.5 py-1 text-[11px] font-mono rounded-none transition-all border text-slate-300 bg-white/5 border-white/10 hover:border-orange-500/35 hover:dark:text-white text-slate-900"
                    >
                      {skill}
                    </span>
                  );
